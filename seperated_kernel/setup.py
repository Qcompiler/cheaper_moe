...
def get_include_dirs():
    ...
    # include_dirs.append(os.path.join(this_dir,"cutlass-src/include"))
    # include_dirs.append(os.path.join(this_dir,"csrc"))
    # include_dirs.append(os.path.join(this_dir,"csrc/cutlass_w8a8"))
    # include_dirs.append(os.path.join(this_dir,"csrc/cutlass_extensions"))
...
def get_library_dirs():
    ...
    this_dir = os.path.dirname(os.path.abspath(__file__))
    include_dirs.append(this_dir)
    include_dirs.append(os.path.join(this_dir,"build"))  
    include_dirs.append(os.path.join(this_dir,"build/kernel"))   
    return include_dirs 
check_dependencies()
...
cuda_extra = ['-lcudart', '-lcublas', '-lcurand', '-lcuda', '-lmixgemm_plugins', '-lkernel']
extensions = [
    CUDAExtension(
        "mixgemm",
        [
