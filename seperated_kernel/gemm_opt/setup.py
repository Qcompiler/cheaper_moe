...
cuda_extra = ['-lcudart', '-lcublas', '-lcurand', '-lcuda']
extensions = [
    CUDAExtension(
        "mixgemm_v2",
        [
            ...
            "csrc/cutlass_w8a8/scaled_mm_c2x.cu",
            "csrc/cutlass_w8a8/scaled_mm_c3x.cu",
            "csrc/cuda_kernel.cu",
            "csrc/int8fuseddequantize.cu"
        ],   
