...
torch::Tensor mixgemmforward(int M, int N, int K, 
                            torch::Tensor & A, torch::Tensor &w, torch::Tensor &s,
                            torch::Tensor &fp_w, torch::Tensor & ind, torch::Tensor & q_w, 
                            torch::Tensor & q_s);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("mixgemmforward", &mixgemmforward,
          "mixgemmforward");  

    m.def("mixgemmforward4bit", &mixgemmforward4bit,
          "mixgemmforward4bit"); 
